            ...
            case TTN_NEEDTEXT:
                {
                    ...
                    case OBJECTRECTANGLE:
                        lstrcpy(lpttdi->szText, L"Rectangle Tool");
                        break;
                    case OBJECTELLIPSE:
                        lstrcpy(lpttdi->szText, L"Ellipse Tool");
                        break;
                    case OBJECTLINE:
                        lstrcpy(lpttdi->szText, L"Line Tool");
                        break;
                    case OBJECTPOINT:
                        lstrcpy(lpttdi->szText, L"Point Tool");
                        break;
                    default:
                        lstrcpy(lpttdi->szText, L"Unknown Tool");
                        break;
                    }
                }
            break;
...
int __stdcall wWinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, PWSTR pCmdLine, int nCmdShow)
{
    ...
    HWND hWnd = CreateWindowEx(WS_EX_LEFT, L"mainWindow", L"homework_C++", WS_OVERLAPPEDWINDOW, 200, 200, 1000, 700, NULL, NULL, hInstance, NULL);
    ...
    tbButtons[0] = { MAKELONG(indexRectangle,  ImageListID), OBJECTRECTANGLE,  TBSTATE_ENABLED, buttonStyles, {0}, 0, (INT_PTR)L"Rectangle" }; 
    tbButtons[1] = { MAKELONG(indexEllipse,  ImageListID), OBJECTELLIPSE,  TBSTATE_ENABLED, buttonStyles, {0}, 0, (INT_PTR)L"Ellipse" }; 
    tbButtons[2] = { MAKELONG(indexLine, ImageListID), OBJECTLINE, TBSTATE_ENABLED, buttonStyles, {0}, 0, (INT_PTR)L"Line" }; 
    tbButtons[3] = { MAKELONG(indexPoint, ImageListID), OBJECTPOINT, TBSTATE_ENABLED, buttonStyles, {0}, 0, (INT_PTR)L"Point" }; 
